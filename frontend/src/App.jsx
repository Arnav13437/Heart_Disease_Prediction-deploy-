...
export default function HeartDiseasePredictor() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      setResult("error");
      setErrorMessage(err.message || "Could not connect to prediction server.");
    }
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1440, margin: "0 auto", padding: "80px 48px 100px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <BlurIn delay={1400}>
            <p style={{ color: colors.muted, fontSize: 16, maxWidth: 800, margin: "0 auto", lineHeight: 1.7 }}>
          ...
          <div style={{
            ...
            <div style={{ marginTop: 40, textAlign: "center" }}>
              <button
                ...
                disabled={loading}
                aria-label="Predict Heart Disease Risk"
                style={{
          ...
          <div ref={resultRef} style={{ marginTop: 28, animation: "cardIn 0.6s ease both" }}>
            {result === "error" ? (
              <div style={{
                ...
                <p style={{ color: "#f87171", fontSize: 16, margin: "0 0 8px" }}>⚠️ Analysis failed.</p>
                <p style={{ color: colors.muted, fontSize: 13, margin: 0 }}>
                  {errorMessage || "Could not connect to prediction server. Please try again."}
                </p>
              </div>
            ) : (
              <div style={{
